...
%---------------------------------------------------------------------- get     
function y = getContactTangentReaction(NeoHookean)
    y = NeoHookean.contact.TangentReaction*...
        getModulus(NeoHookean);
    end
%---------------------------------------------------------------------- get     
function y = getContactFriction(NeoHookean)
y = NeoHookean.contact.ContactFriction;
end
%---------------------------------------------------------------------- get     
function y = getContactDamping(NeoHookean)
y = NeoHookean.contact.NormalDamping...
    *getModulus(NeoHookean);
end
%---------------------------------------------------------------------- get    
